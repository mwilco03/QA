/**
 * LMS Course Extractor v9.0 - Fire and Forget
...
(function() {
    ...
    const CONFIG = {
        ...
        // API endpoint templates (use with template literals)
        endpoints: {
        ...
        answerTypes: ['checkbox', 'radiobutton', 'button', 'hotspot', 'dragitem', 'dropzone', 'droptarget', 'textentry'],
        excludeNav: ['continue', 'next', 'back', 'previous', 'submit', 'exit', 'close', 'menu', 'home', 'restart', 'replay', 'review'],
